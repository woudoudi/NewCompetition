 ...
 * @author zhaolong
 */
public class LoadingVideoView extends View {
    ...
    public LoadingVideoView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        @SuppressLint("CustomViewStyleable")
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ScanLoadingViewAttrs);
        String mode = typedArray.getString(R.styleable.ScanLoadingViewAttrs_startmode);
    ...
    private static class ProgressHandler extends Handler {
        WeakReference<LoadingVideoView> weakReference;

        ProgressHandler(LoadingVideoView view) {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == CODE_PROGRESS_START) {
                LoadingVideoView loadingView = weakReference.get();
                if (loadingView != null) {
