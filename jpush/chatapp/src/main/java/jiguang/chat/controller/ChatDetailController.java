...
public class ChatDetailController implements OnClickListener, OnItemClickListener,
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.group_desc_ll) {
            mContext.updateGroupNameDesc(mGroupId, 2);

        } else if (i == R.id.rl_groupAvatar) {
        ...
        } else if (i == R.id.tv_moreGroup || i == R.id.moreGroupMember) {//群成员列表,gridView
        ...
        } else if (i == R.id.chat_detail_add_friend) {
