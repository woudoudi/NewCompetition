 ...
 * Date: 2019/8/15
 */
@RequestrAnnotation(baseUrl = ILocalHost.ycUrl,path = ILocalHost.updateLiveInfo,method = RequestMethodEnum.PUT)
public class UpdateLiveInfoRequestBean extends BaseBean implements ILocalHost {
