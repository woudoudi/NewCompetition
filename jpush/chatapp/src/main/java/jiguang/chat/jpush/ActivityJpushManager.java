...
public class ActivityJpushManager {
	private static Stack<Activity> activityStack = new Stack<Activity>();

	private ActivityJpushManager() {
	}

	private static class ManagerHolder {
		private static final ActivityJpushManager instance = new ActivityJpushManager();
	}

	public static ActivityJpushManager getInstance() {
